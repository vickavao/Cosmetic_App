@php
    ...
    $navLinks = match (auth()->user()?->role) {
        \App\Enums\Role::ChefMarketing => [
            ...
            ['route' => 'announcements.index', 'label' => 'Actualités', 'icon' => $icons['messages']],
        ...
        \App\Enums\Role::Magasinier => [
            ['route' => 'dashboard', 'label' => 'Dashboard', 'icon' => $icons['dashboard']],
            ['route' => 'orders.to-prepare', 'label' => 'Commandes à préparer', 'icon' => $icons['orders']],
            ['route' => 'products.index', 'label' => 'Stock', 'icon' => $icons['products']],
        ...
        \App\Enums\Role::Client => [
            ...
            ['route' => 'portal.news', 'label' => 'Nouveautés & Événements', 'icon' => $icons['messages']],
            ['route' => 'portal.profile', 'label' => 'Mon Profil', 'icon' => $icons['clients']],
